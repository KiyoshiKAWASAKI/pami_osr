...
python -W ignore train_dense_net.py --train_known_known_path /afs/crc.nd.edu/user/j/jhuang24/scratch_22/open_set/data/object_recognition/image_net/derivatives/dataset_v1_3_partition/npy_json_files/test_known_known.json \
                                   ...
                                   --save /afs/crc.nd.edu/user/j/jhuang24/scratch_22/open_set/models/sail-on/dense_net/debug \
                                   --log_file_path None \
